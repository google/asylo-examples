...
http_archive(
    ...
    urls = ["https://github.com/google/asylo/archive/v0.6.2.tar.gz"],
    sha256 = "17b5d8547056daf847570afe304993f2df42ffccd5d78e1172c21e369738969d",
    strip_prefix = "asylo-0.6.2",
)
